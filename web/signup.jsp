...
<html lang="en">
  ...
  <body class="text-center">
    <form class="form-signup">
      ...
      <div class="mb-3">
        <input type="studentid" id="inputStudentID" class="form-control" placeholder="请输入学号" required autofocus>
        <div class="invalid-feedback">请输入正确的学号！</div>
      </div>
      <!--
      <button class="btn btn-lg btn-success btn-block" type="submit">注册</button>
      -->
      <a class="btn btn-md btn-success btn-block" href="signup2.jsp">下一步</a>
      <a class="btn btn-md btn-success btn-block" href="signin.jsp">返回</a>
      <!--
